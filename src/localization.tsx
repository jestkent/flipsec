...
const EN = {
  ...
  lessonInEnglish: "This interactive lesson is in English.",
  stageSetup: "The setup",
  stageHook: "The hook",
  stageLoss: "The loss",
...
const ES: Record<Key, string> = {
  ...
  lessonInEnglish: "Esta lección interactiva está en inglés.",
  stageSetup: "La preparación",
  stageHook: "El anzuelo",
  stageLoss: "La pérdida",
...
const HI: Record<Key, string> = {
  ...
  lessonInEnglish: "यह इंटरैक्टिव पाठ अंग्रेज़ी में है।",
  stageSetup: "तैयारी",
  stageHook: "फंसाना",
  stageLoss: "नुकसान",
...
const FIL: Record<Key, string> = {
  ...
  lessonInEnglish: "Ang interactive na araling ito ay nasa Ingles.",
  stageSetup: "Ang paghahanda",
  stageHook: "Ang pain",
  stageLoss: "Ang pagkawala",
...
const VI: Record<Key, string> = {
  ...
  whatWasReal: "Sự thật",
  lessonInEnglish: "Bài học tương tác này bằng tiếng Anh.",
  stageSetup: "Dàn dựng",
  stageHook: "Mắc bẫy",
  stageLoss: "Mất mát",
...
const RU: Record<Key, string> = {
  ...
  lessonInEnglish: "Этот интерактивный урок на английском языке.",
  stageSetup: "Подготовка",
  stageHook: "Крючок",
  stageLoss: "Потеря",
...
const JA: Record<Key, string> = {
  ...
  whatYouSaw: "あなたが見たもの",
  whatWasReal: "実際のこと",
  lessonInEnglish: "この対話型レッスンは英語です。",
  stageSetup: "仕掛け",
  stageHook: "誘い込み",
  stageLoss: "被害",
  teachMe: "この手口を教えて",
...
const KO: Record<Key, string> = {
  ...
  whatYouSaw: "당신이 본 것",
  whatWasReal: "실제였던 것",
  lessonInEnglish: "이 대화형 학습은 영어로 제공됩니다.",
  stageSetup: "덫 놓기",
  stageHook: "미끼",
  stageLoss: "피해",
  teachMe: "이 수법을 알려주세요",
...
const PT: Record<Key, string> = {
  ...
  lessonInEnglish: "Esta lição interativa está em inglês.",
  stageSetup: "A preparação",
  stageHook: "A isca",
  stageLoss: "A perda",
...
const FR: Record<Key, string> = {
  ...
  lessonInEnglish: "Cette leçon interactive est en anglais.",
  stageSetup: "La mise en place",
  stageHook: "L'hameçon",
  stageLoss: "La perte",
