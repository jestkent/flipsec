...
| C-1 | Ask FlipSec recommended "check for poor spelling and grammar" — the exact heuristic the app exists to refute — because its system prompt never stated the premise | **High** | Fixed `1095ebc` |
